...
\begin{block}{}
\lstinputlisting[language=Python]{function_example1.py}
\end{block}
...
\begin{block}{}
\lstinputlisting[language=Python]{function_example2.py}
\end{block}
...
\begin{block}{}
\lstinputlisting[language=Python]{function_example3.py}
\end{block}
